...
public class TestParametrizeSubtraction extends Assert {

    private int valueA;
    private int valueB;
    private int expected;

    public TestParametrizeSubtraction(int valueA, int valueB, int expected) {
        this.valueA = valueA;
        this.valueB = valueB;
    ...
    public void ParametrizeTest() {
        assertEquals(expected, CalculatorAddition.subtraction(valueA, valueB));
